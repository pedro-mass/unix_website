...
<div id="pageNav" class="pageNavSummary" style="margin:2px;">
	<a href='unix.php?page=page_parts/tutorials/' onclick="swapMainTerm('page_parts/tutorials/summaries/file_manip_summary.php', 'page_parts/tutorials/summaries/file_manip_summary.php');">Previous</a> 
	| 
