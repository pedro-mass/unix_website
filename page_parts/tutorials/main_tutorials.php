<div id="content_padding">
	...
	<div id="right_content">
		<ul class="accordian">
			...
			<li id="tut2">
				<h2><a id="tut2link" onclick="listOpen('tut2','tut2link', '110px')">Intermediate Tutorials</a></h2>
				<ul>
			...
			<li id="tut3">
				<h2><a id="tut3link" onclick="listOpen('tut3','tut3link', '70px')">Advanced Tutorials</a></h2>
				<ul>
