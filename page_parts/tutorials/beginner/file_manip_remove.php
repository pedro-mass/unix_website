						...
						<p>
							...
							<div id="pageNav">
								<a href='unix.php?page=page_parts/tutorials/beginner/file_manip_move.php' onclick="swapMainTerm('page_parts/tutorials/beginner/file_manip_move.php', 'page_parts/tutorials/beginner/file_manip_move.php');">Previous </a> 
								 |  
								<a href='unix.php?page=page_parts/tutorials/summaries/file_manip_summary.php' onclick="swapMainTerm('page_parts/tutorials/summaries/file_manip_summary.php', 'page_parts/tutorials/summaries/file_manip_summary.php');"> Next</a>
							</div>
						</p>
