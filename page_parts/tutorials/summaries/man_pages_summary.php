						...
						<div style="margin:auto;">
							<table border="1" cellpadding="2" cellspacing="0">
								...
								<tr>
									<td>man command</td>
									<td>looks up the manual for the command</td>
								</tr>
								<tr>
									<td>whatis command</td>
									<td>one-description of the command</td>
								</tr>
							</table>
						</div>
						...
						<div id="pageNav" class="pageNavSummary" style="margin:2px;">
							<a href='unix.php?page=page_parts/tutorials/beginner/man_pages.php' onclick="swapMainTerm('page_parts/tutorials/beginner/man_pages.php');">Previous</a> 
							| 
