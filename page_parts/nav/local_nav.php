<div id='local_nav'>
						<ul>
							<li><a href='unix.php?page=page_parts/index/main_index.php&side=home' onclick="swapMultiple('page_parts/index/main_index.php','page_parts/side_bar/side_bar_home.php');">index</a></li> 
