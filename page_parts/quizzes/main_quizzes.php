<div id="content_padding">
	...
	<div id="left_content">
		...
		<p>
			Please select a quiz on the right to begin your lesson. You can progress sequentially, or jump straight to your quiz of choice.
		</p>
		...
		<ul class="accordian">
			<li id="tut1">
				...
				<ul>
					...
					<li><a href='unix.php?page=page_parts/tutorials/beginner/file_name/quiz.php&side=quiz' onclick="swapMain('page_parts/tutorials/beginner/file_name/quiz.php');">File Names</a></li>
					<li><a href='unix.php?page=page_parts/tutorials/beginner/file_manip/quiz.php&side=quiz' onclick="swapMain('page_parts/tutorials/beginner/file_manip/quiz.php');">File Manipulation</a></li>
					<li><a href='unix.php?page=page_parts/tutorials/beginner/help/quiz.php&side=quiz' onclick="swapMain('page_parts/tutorials/beginner/help/quiz.php');">Getting Help</a></li>
				</ul>
			</li>
			...
			<li id="tut2">
				...
				<ul>
					...
					<li><a href='unix.php?page=page_parts/tutorials/intermediate/misc/quiz.php&side=quiz' onclick="swapMain('page_parts/tutorials/intermediate/misc/quiz.php');">Miscellaneous</a></li>					
				</ul>
			</li>
