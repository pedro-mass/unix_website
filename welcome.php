...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>	
		...
		<?php include_once('page_parts/css_include.php'); ?>
		<!-- Bring in the javascript links -->
		<?php include_once('page_parts/javascript_include.php'); ?>
	</head>
	<body onload="stripATags()">
		<div id='wrapper'>
			...
			<div id='main'><div id='main_wrapper'>		
				...
				<?php include_once('page_parts/side_bar.php') ?>
